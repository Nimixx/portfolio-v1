  ...
  return (
    <section className="mt-14 flex w-full flex-col items-start space-y-5">
      ...
      <p className="text-gray-600 dark:text-gray-400">
        Rád se učím novým věcem a neustále se zdokonaluji v těch, které již
        znám. Většinu svého času trávím v{' '}
        <strong className="text-sky-400">Reactu</strong>, ale nejsou mi cizí i
        další technologie, jako například{' '}
        <strong className="text-blue-500">TypeScript</strong>,{' '}
